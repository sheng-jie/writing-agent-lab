namespace WritingAgent.Application.Agents.WritingIntent;

public sealed class WritingIntentAgentDefinition() : AgentDefinition(
    AgentIds.WritingIntentAgent,
    "Writing Intent Agent",
    "在捕捉想法阶段识别并维护写作意图。",
    Instruction,
    allowedToolNames:
    [
